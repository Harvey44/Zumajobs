...
class Asearch extends StatefulWidget {
  String query;
  Asearch({
    Key key,
    this.query,
  ...
  @override
  _AsearchState createState() => _AsearchState();
}

class _AsearchState extends State<Asearch> {
  String key, type;
  bool premium;
  ...
  FutureBuilder _buildApplicants(BuildContext context) {
    ...
    return FutureBuilder<ApplicantResp>(
        future: Provider.of<ApiService>(context, listen: false).find_app(data),
                        ...
                        Padding(
                          ...
                          child: Text(
                              applicant.applicant[index].first_name +
                                  " " +
                                  applicant.applicant[index].last_name,
                              style: TextStyle(
  ...
  BottomSheetView(context, ApplicantResp applicant, index) {
    ...
    if (type == "applicant") {
      phone = applicant.applicant[index].phone
          .replaceRange(2, applicant.applicant[index].phone.length, "****");
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Center(
                    child: Text(
                        applicant.applicant[index].first_name + " " + last,
                        style: TextStyle(
                            fontWeight: FontWeight.bold,
                            color: Colors.green,
                            fontSize: 16)),
                      ...
                      child: Column(
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                                applicant.applicant[index].degree + " degree",
                ...
                VideoView(context, applicant.applicant[index].video),
                Padding(
        ...
        floatingActionButton: Align(
          ...
          child: Padding(
            ...
            child: FloatingActionButton.extended(
                ...
                label: Text("Contact ${applicant.applicant[index].first_name}",
                    style: TextStyle(
                        color: Colors.white,
                        fontSize: 16,
                        fontWeight: FontWeight.bold),
